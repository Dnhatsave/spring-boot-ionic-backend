...
public class BDService {
	...
	public void instatiateDatabase() throws ParseException {
		...
		Categoria cat4 = new Categoria(null, "Detergentes");
		Categoria cat5 = new Categoria(null, "Electronicos");
		...
		Produto p7 = new Produto(null, "Tv Samsung", 1200.00);
		Produto p8 = new Produto(null, "Rebarbadeira", 500.00);
		Produto p9 = new Produto(null, "Shampoo", 140.00);
		Produto p10 = new Produto(null, "Cadeira Escritorio", 150.00);
		Produto p11 = new Produto(null, "Auriculates", 500.00);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "dercionhatsave@gmail.com", "21323123123",TipoCliente.PESSOAFISICA);
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE,ped2,
				sdf.parse("20/10/2017 10:00"),null);
